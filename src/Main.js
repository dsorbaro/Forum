...
function Main() {
      ...
      <div class="row">
        ...
        <div>
                ...
                <div class="innerTitleDiv">
                    <RequestButtons title="Public figures" mainText="What public figure would you like to call to debate?"/>
                    <RequestButtons title="Debate Topic" mainText="On what trending news topic do you want to see a debate?"/>
                    <RequestButtons title="Public figures" mainText="What public figure would you like to call to debate?"/>
    ...
    <h4> Today's Trending Conversation Requests </h4>
        ...
        <div class="trendingNewstopicstext"> <h4>Trending News Topics</h4></div>
    </div>
</div>
      </div>
