...
class Main extends Component {
  ...
  render() {
    ...
    var error =
      this.state.notLoggedIn == null ? null : (
        <p class="youneedtobeloggedintext">
          {" "}
    ...
    var requestColums =
      this.props.popularRequests == null ? (
        <p> no requests </p>
      ) : (
        Object.keys(this.props.popularRequests).map((item) => {
          return <OneTrendingRequest info={this.props.popularRequests[item]} />;
        })
      );
...
function mapStateToProps(state) {
  return {
    ...
    popularRequests: state.requests.mostPopular,
    debates: state.debate.all,
  };
}
